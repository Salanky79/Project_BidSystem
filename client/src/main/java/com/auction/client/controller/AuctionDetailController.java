...
public class AuctionDetailController {
    ...
    private VBox buildCommentRow(String author, String text, String timestamp) {
        ...
        authorLabel.setStyle("-fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: #c9a84c;");
        ...
        textLabel.setStyle("-fx-font-size: 13px; -fx-text-fill: white; -fx-wrap-text: true;");
    ...
    public static void open(
        ...
        try {
            FXMLLoader loader = new FXMLLoader(
                    AuctionDetailController.class.getResource("/com/auction/client/view/AuctionDetail.fxml")
            );
    ...
    private void handlePostComment() {
        ...
        VBox row = buildCommentRow("You", text, LocalDateTime.now().format(FORMATTER));
    ...
    void handleFollowAction(ActionEvent event) {
        if (btnFollow.isSelected()) {
            ...
            System.out.println("Added this product to Watchlist.");
        } else {
            ...
            System.out.println("Removed this product from Watchlist.");
        }
    }
}
